...
<header class="bg-white">
    ...
    <section class="container mx-auto p-4">
        <form action="insert_country.php" method="POST" class="bg-white p-6 rounded-lg shadow-md">
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="number" id="population" name="population" class="w-full px-3 py-2 border rounded-md" required>
            </div>
            <div class="mb-4">
                <label for="languages" class="block text-sm font-bold mb-2">Official Language</label>
                <input type="text" id="languages" name="languages" class="w-full px-3 py-2 border rounded-md" required>
            </div>
            <input type="hidden" name="continent_id" value="1"> 
            <button type="submit" class="bg-yellow-900 text-white px-4 py-2 rounded-md">Add Country</button>
        </form>
    </section>

 <!-- Footer -->
  
 <div class="bg-orange-800 text-white text-center p-4 mt-8">

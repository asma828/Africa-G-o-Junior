...
<header class="bg-white">
    ...
    <section class="container mx-auto p-4">
        <form action="insert_city.php" method="POST" class="bg-white p-6 rounded-lg shadow-md">
            <div class="mb-4">
           ...
           include '../src/connect.php';
            ...
            <div class="mb-4">
                <label for="city_name" class="block text-sm font-bold mb-2">City Name</label>
                <input type="text" id="city_name" name="city_name" class="w-full px-3 py-2 border rounded-md" required>
            </div>
            <div class="mb-4">
            ...
            <button type="submit" class="bg-yellow-900 text-white px-4 py-2 rounded-md">Add City</button>
        </form>
    </section>
